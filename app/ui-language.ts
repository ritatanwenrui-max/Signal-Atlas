...
const ENGLISH: Record<string, string> = {
  ...
  "按需评论任务与分析": "On-demand comments and analysis",
  ...
  "风险优先": "Highest risk",
  "手动补充": "Add manually",
  "内容已归档，公开互动数据捕捉已启动": "Content archived. Public engagement capture has started.",
  "互动数据排队中": "Engagement data queued",
  "正在读取互动数据": "Reading engagement data",
  "互动数据已更新": "Engagement data updated",
  "已读取页面资料": "Page metadata captured",
  "互动数据读取失败": "Engagement capture failed",
  "采集并分析评论": "Collect and analyze comments",
  "重新采集评论": "Collect comments again",
  "正在采集…": "Collecting…",
  "导出 CSV": "Export CSV",
  "发布时间": "Published",
  "平台": "Platform",
  ...
  "保存链接后会自动识别平台并读取公开的点赞、评论数、转发和播放数据；评论正文与情绪分析只有手动开启后才会采集。": "After you save a link, the system identifies its platform and captures public likes, comment counts, shares, and views. Comment text and sentiment are collected only when you start them manually.",
  "保存并捕捉公开数据": "Save and capture public data",
  "等待手动选择帖子": "Waiting for a manually selected post",
  "手动任务采集中": "Manual task in progress",
  "当前手动队列已完成": "Manual queue completed",
  "自动归档帖子": "Archive posts automatically",
  "只保留内容与互动数": "Keep content and engagement counts",
  "人工选择目标": "Select targets manually",
  "点击采集并分析评论": "Click to collect and analyze comments",
  "按需采集评论": "Collect comments on demand",
  "评论正文不会自动采集。请先在“数据采集”配置 Monid，再对需要分析的帖子手动点击采集。": "Comment text is not collected automatically. Configure Monid under Data Collection, then manually start collection for the posts you want to analyze.",
  "手动评论任务状态": "Manual comment task status",
  "尚未手动开启评论任务。可在新闻档案选择具体内容，或在上方粘贴帖子链接。": "No comment task has been started manually. Select an item in the Media Archive or paste a post link above.",
  "关键词发现 · 详情补全 · 评论按需采集": "Keyword discovery · Detail enrichment · On-demand comments",
  ...
  "新闻与博客发现": "News and blog discovery",
  "新闻档案优先使用多个独立新闻源、全球博客索引和社交搜索索引发现新内容；搜索与归档确认没有新增后，后台才进入帖子评论、回复和受众分析阶段。": "The archive first uses independent news sources, global blog indexes and social search indexes to discover new content. Comment, reply and audience collection begins only after discovery and archiving confirm there are no further additions.",
  ...
  "内容档案自动保留发布时间、平台、原文、媒体或账号、地区、原始链接、事件编号和公开互动数据。手动补充链接后也会立即尝试读取点赞、评论数、分享、播放或浏览数据。平台没有披露某项指标时字段留空，只有接口明确返回零时才显示零。": "The archive automatically retains publication time, platform, original content, publisher or account, region, source URL, event ID, and public engagement data. Manually added links immediately trigger an attempt to capture likes, comment counts, shares, plays, or views. Undisclosed metrics stay blank; zero is shown only when the source explicitly returns zero.",
  "评论正文和评论情绪分析采用按需模式，不再随日常巡检自动采集。用户需要在新闻档案或受众舆情页面选择具体帖子，点击“采集并分析评论”后，系统才按“采集主评论、采集回复、翻译与分析”的顺序调用接口；历史评论和人工标注会继续保留。": "Comment text and sentiment analysis are now on demand and no longer run automatically during routine scans. Select a specific item in Media Archive or Audience Intelligence and click Collect and analyze comments. Only then will the system collect top-level comments, replies, translations, and analysis. Existing comments and human labels are preserved.",
  "系统会把品牌名、无空格写法、别名、产品、事件指纹、官网域名以及“品牌名＋身份锚点”组合成搜索计划。Instagram 使用适合 hashtag 的无空格词形，YouTube 与 TikTok 会分别执行前三组高优先级关键词；NewsAPI.ai 在首批达到一百条时自动继续请求后续页面。搜索与归档不会自动触发评论正文采集。": "The search plan combines the brand name, unspaced variants, aliases, products, event fingerprints, official domain, and brand-plus-identity anchors. Instagram uses hashtag-compatible unspaced terms, while YouTube and TikTok run the first three high-priority keyword groups. NewsAPI.ai automatically requests more pages when the first batch reaches 100 results. Discovery and archiving do not automatically trigger comment-text collection.",
  ...
  "网页新闻": "Web news",
  "博客": "Blogs",
  "WordPress.com 全球博客标签": "WordPress.com global blog tags",
  "DEV / Forem 公开博客关键词搜索": "DEV / Forem public blog keyword search",
  "Tumblr 多语言博客标签搜索": "Tumblr multilingual blog tag search",
  "使用 Tumblr 免费开发者应用的 OAuth Consumer Key，按品牌、产品和事件标签检索公开多语言博客。接口只返回带有对应标签的帖子，不会搜索私人博客。": "Use the OAuth Consumer Key from a free Tumblr developer application to search public multilingual blogs by brand, product and event tags. The API returns tagged public posts only and never searches private blogs.",
  "前往 Tumblr 注册应用并获取 Consumer Key ↗": "Register a Tumblr app and obtain a Consumer Key ↗",
  "公开账号": "Public account",
  "低": "Low",
  "中": "Medium",
  "高": "High",
