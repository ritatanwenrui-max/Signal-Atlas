...
function CoverageView({ connectors, sources, submit }: { connectors: Connector[]; sources: MediaSource[]; submit: (payload: Record<string, unknown>, success: string) => Promise<unknown> }) {
  ...
  return <div className="coverage-page">
    <section className="coverage-architecture panel-dark"><div><h2>采集计划</h2><p>NewsAPI.ai 每 6 小时、GDELT 每日搜索新报道和媒体；系统每小时检查到期任务，活跃来源每 3 小时抓取，待探测来源每 12 小时重试。</p></div><div className="architecture-flow"><article><b>01</b><strong>全球发现</strong><span>NewsAPI.ai / GDELT</span><small>每 6 小时 / 每日</small></article><i>→</i><article><b>02</b><strong>来源库</strong><span>{sources.length} 个媒体域名</span><small>自动更新</small></article><i>→</i><article><b>03</b><strong>来源追踪</strong><span>RSS / Atom / Sitemap</span><small>活跃 3h / 探测 12h</small></article></div></section>
